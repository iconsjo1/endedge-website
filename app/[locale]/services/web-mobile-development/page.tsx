...
export async function generateMetadata({
  ...
  const path = `/${locale}/services/${WEB_MOBILE_SLUG}`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        en: `/en/services/${WEB_MOBILE_SLUG}`,
        ar: `/ar/services/${WEB_MOBILE_SLUG}`,
        "x-default": `/en/services/${WEB_MOBILE_SLUG}`,
      },
    },
    openGraph: {
...
export default function WebMobileDevelopmentPage({
  ...
  const locale = params.locale as Locale;
  const c = getWebMobilePageContent(locale);
