      ...
      <main className="bg-ink pt-24 text-mist">
              ...
              <table className="w-full min-w-[640px] border-collapse text-sm">
                ...
                <tbody>
                  {c.explainer.rows.map((row) => (
                    <tr key={row.label} className="border-b border-slate-line/70 align-top">
        ...
        <section className="border-y border-slate-line bg-paper py-16 text-graphite">
          <div className="shell max-w-3xl">
            ...
            <p className="mt-4 text-base leading-relaxed text-stone">{c.proof.smartErp}</p>
        ...
        <section id={c.lead.id} className="shell scroll-mt-28 py-16">
          <div className="max-w-2xl">
            ...
            <p className="mt-4 text-base leading-relaxed text-muted">{c.lead.body}</p>
          </div>
